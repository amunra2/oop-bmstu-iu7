...
#include "../../inc/commands/viewer_command.h"
#include "../../inc/viewer/viewer.h"
...
MoveViewerCommand::MoveViewerCommand(const size_t &viewer_num, const double &dx, const double &dy) : _viewer_num(viewer_num), _dx(dx), _dy(dy) { }
